...
# My version of git comes from msys and posh-git doesn't like it.
$env:POSHGIT_CYGWIN_WARNING = 'off'

# Currently, almost everything below comes from Scott Hanselman. I haven't
# learned enough Powershell yet.
...
# This has to precede all the following shenanigans because it seems to
